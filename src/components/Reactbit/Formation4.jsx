...
const Formation = () => {
  ...
  <div className="cardzz">
    <div className="image-container">
     <img style={{height:'100%',width:'100%'  }}   src='https://static.vecteezy.com/system/resources/thumbnails/013/949/182/small_2x/set-of-popular-adobe-apps-icons-free-vector.jpg'></img>
    ...
    <div className="content">
      <div className="brand">Adobe</div>
      <div className="product-name">All adebe certificates</div>
    ...
    <div className="button-container">
      <button className="buy-button button">Add </button>
      <button className="cart-button button">
      <img style={{width:20}} src='https://cdn-icons-png.flaticon.com/512/5610/5610959.png'></img>
      </button>
    </div>
  </div>
    </div>
