...
const Formation = () => {
  ...
  <div className="cardzz">
    <div className="image-container">
     <img style={{height:'100%',width:'100%'  }}   src='https://les-tilleuls.coop/wp-content/uploads/2023/11/vignette-symfony-1-1024x614.png'></img>
      <div className="price">+31</div>
    </div>
    ...
    <div className="content">
      <div className="brand">Symfony 7 </div>
      <div className="product-name"> symfony 7 certificate  </div>
